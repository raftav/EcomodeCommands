...
def test():
	...
	filename_test=['/home/local/IIT/rtavarone/Data/PreProcessEcomodeItalian/DELTAS_TFRECORDS/TEST_FEAT_INEC_TFRECORDS/sequence_full_{:04d}.tfrecords'.format(i) \
	...
	with tf.Graph().as_default():
		...
		with tf.Session(config=tf.ConfigProto(allow_soft_placement=True,
			...
			try:
				...
				plot=plot_confusion_matrix(cnf_matrix, classes=classes, normalize=False,
