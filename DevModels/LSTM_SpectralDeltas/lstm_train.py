...
def train():
	...
	filename_train=['/home/local/IIT/rtavarone/Data/PreProcessEcomode/RecurrentData_SpectralDeltas/TRAIN/sequence_full_{:04d}.tfrecords'.format(i) \
					 for i in range(num_examples)]
	for f in filename_train:
		if not tf.gfile.Exists(f):
			raise ValueError('Failed to find file: ' + f)

	filename_val=['/home/local/IIT/rtavarone/Data/PreProcessEcomode/RecurrentData_SpectralDeltas/VAL/sequence_full_{:04d}.tfrecords'.format(i) \
