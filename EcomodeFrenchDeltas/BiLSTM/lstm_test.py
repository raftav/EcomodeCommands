...
def test():
	...
	filename_test=['/home/local/IIT/rtavarone/Data/PreProcessEcomodeFrench/DELTAS_TFRECORDS/TEST_FEAT_TFRECORDS/sequence_full_{:04d}.tfrecords'.format(i) \
	...
	with tf.Graph().as_default():
		...
		with tf.Session(config=tf.ConfigProto(allow_soft_placement=True,
			...
			try:
				...
				classes = []
				for i in range(19):
					classes.append( 'fpec_{:03d}'.format(i+1) )
				classes.append('frec_or_fnec')
