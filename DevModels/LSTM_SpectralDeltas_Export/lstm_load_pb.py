...
data = np.load('/home/local/IIT/rtavarone/Data/PreProcessEcomode/RecurrentData_SpectralDeltas/TEST_NUMPY/features_sentence{}.npy'.format(sentence_index),allow_pickle=False)
...
test_labels=np.load('/home/local/IIT/rtavarone/Data/PreProcessEcomode/RecurrentData_SpectralDeltas/TEST_NUMPY/labels_sentence{}.npy'.format(sentence_index),allow_pickle=False)
