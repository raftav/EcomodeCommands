...
test_features=sorted(glob.glob('/home/local/IIT/rtavarone/Data/PreProcessEcomodeItalian/DELTAS_TFRECORDS/TEST_FEAT_INEC_NUMPY/features_*.npy'))
test_labels=sorted(glob.glob('/home/local/IIT/rtavarone/Data/PreProcessEcomodeItalian/DELTAS_TFRECORDS/TEST_FEAT_INEC_NUMPY/label_*.npy'))
