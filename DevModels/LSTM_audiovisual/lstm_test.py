...
def test():
	...
	filename_test=['/home/local/IIT/rtavarone/Data/PreProcessEcomode/MultiModalData/HIGHDIM_FEAT/TEST/sequence_full_{:04d}.tfrecords'.format(i) \
