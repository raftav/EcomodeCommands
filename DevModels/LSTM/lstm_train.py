...
def train():
	...
	filename_train=['/DATA_NEW/rtavarone/Ecomode_Sentences_2018/RecurrentData/TRAIN/sequence_full_{:04d}.tfrecords'.format(i) \
					 for i in range(num_examples)]
	for f in filename_train:
		if not tf.gfile.Exists(f):
			raise ValueError('Failed to find file: ' + f)

	filename_val=['/DATA_NEW/rtavarone/Ecomode_Sentences_2018/RecurrentData/VAL/sequence_full_{:04d}.tfrecords'.format(i) \
